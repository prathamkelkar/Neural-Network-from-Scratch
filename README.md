...
- `NN_helper_functions.py` — the core neural network implementation: forward/backward propagation, cost computation, parameter initialization and updates, mini-batch generation, and training loops (both full-batch and epoch/mini-batch based)
